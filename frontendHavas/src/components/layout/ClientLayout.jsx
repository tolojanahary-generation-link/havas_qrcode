...
const navigation = [
  ...
  { name: "Mes QR Codes", href: "/client/qrcodes", icon: QrCode },
  { name: "Tracking", href: "/client/tracking", icon: BarChart3 },
];
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuLabel>
                <div className="flex flex-col">
                  <span>{user?.name || "Collaborateur"}</span>
                  <span className="text-xs text-muted-foreground font-normal">
                    {user?.email || "user@havas.com"}
                  </span>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
